...
function () {
  function Input(index, style) {
    ...
    this.style = style; // TODO calculate this from font size so it works for smaller sizes

    this.height = 1;
    this.depth = 0.1;
  }

  var _proto4 = Input.prototype;
  ...
  _proto4.toNode = function toNode() {
    ...
    node.setAttribute("data-idx", this.index.toString()); // Apply inline styles
  ...
  _proto4.toMarkup = function toMarkup() {
    var markup = "<input  type='tel' class='number-input zearn-input' ";
    markup += "data-idx='" + this.index + "' "; // Add the styles, after hyphenation
...
function () {
  ...
  var _proto5 = SymbolNode.prototype;

  _proto5.hasClass = function hasClass(className) {
    return utils.contains(this.classes, className);
  }
  /**
...
function () {
  ...
  var _proto7 = PathNode.prototype;
...
function () {
  ...
  var _proto8 = LineNode.prototype;
...
// CONCATENATED MODULE: ./src/functions/zInput.js
...
defineFunction({
  ...
  handler: function handler(_ref, args, optArgs) {
    ...
    var index = parseInt(assertNodeType(args[0], "raw").string);
    return {
      type: "zInput",
      mode: parser.mode,
      index: index,
  ...
  htmlBuilder: function htmlBuilder(group, options) {
    ...
    var node = new domTree_Input(group.index, style);
    return node;
  },
  mathmlBuilder: function mathmlBuilder(group, options) {
    var node = new mathMLTree.MathNode("mglyph", []);
